    ...
    <div class="container">
        <div class="row my-5 py-3">
            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                <img src="images/Portfolio 16.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img1" />

                <img src="images/Portfolio 26.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img2" />
                <img src="images/Portfolio 17.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img2" />
            </div>

            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="images/Portfolio 24.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img3" />
                <img src="images/Portfolio 27.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img3" />
                <img src="images/Portfolio 31.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img3" />
            </div>
            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="images/Portfolio 28.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img3" />
                <img src="images/Portfolio 29.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img3" />
                <img src="images/Portfolio 30.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="img3" />
            </div>

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav gap-40">
                    <li class="nav-item"> <a class="nav-link active text-body-emphasis" aria-current="page" href="#">Home </a> </li>

                    <li class="nav-item text-body-emphasis"><a class="nav-link text-body-emphasis" href="#">About Us</a>
                    </li>

                    <li class="nav-item dropdown" id="myDropdown">
                        <a class="nav-link dropdown-toggle text-body-emphasis" href="#" data-bs-toggle="dropdown">Categories</a>
                    ...
                    <li class="nav-item dropdown" id="myDropdown">
                        <a class="nav-link dropdown-toggle text-body-emphasis" href="#" data-bs-toggle="dropdown">Services</a>
                        <ul class="dropdown-menu p-0">
                            <li> <a class="dropdown-item py-2" href="#"> Dropdown item 1 &raquo; </a>
                                <ul class="submenu dropdown-menu p-0">
                                    <li><a class="dropdown-item py-2" href="#">Submenu item 1</a></li>
                    ...
                    <li class="nav-item text-body-emphasis"><a class="nav-link text-body-emphasis" href="#">Portfolio</a></li>

    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper" style="position: static; font-family: Arial, sans-serif;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="photographers.php">Photographers Team</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container mt-5">
                ...
                <br>
                <hr>
                <h4 class="text-center">Event Photographers</h4>

                <form action="insertPhotographers.php" method="post">
            ...
            <br><br>
            <hr>
            <h4 class="text-center"> All Event Photographers Details</h4>
                ...
                <table class="table table-bordered mt-4">
                    ...
                    ?>
                        <tr>
                            ...
                            <!-- </td> -->
                            <td>
                                <?php echo $row["photographer_email"]; ?>
                            </td>
                            <td>
                                <?php echo $row["photographer_phone_no"]; ?>
                            </td>
                        </tr>
                    <?php
                    }

    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white" id="sidebar-wrapper" style="position: static; font-family: Arial, sans-serif;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a class="list-group-item list-group-item-action list-group-item-light p-3 active" href="decorators.php">Decorators Team</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container mt-5">
                ...
                <br>
                <hr>
                <h4 class="text-center">Event Decorators</h4>

                <form action="insertDecorators.php" method="post">
            ...
            <br><br>
            <hr>
            <h4 class="text-center"> All Decorators Details</h4>
                ...
                <table class="table table-bordered mt-4">
                    ...
                    ?>
                        <tr>
                            ...
                            <!-- </td> -->
                            <td>
                                <?php echo $row["decorator_email"]; ?>
                            </td>
                            <td>
                                <?php echo $row["decorator_phone_no"]; ?>
                            </td>
                        </tr>
                    <?php
                    }

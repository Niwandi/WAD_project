    ...
    <div class="container">
        <div class="row my-5 py-3">
            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                <img src="images/portfolio- 2.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Boat on Calm Water" />

                <img src="images/Portfolio 3.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Wintry Mountain Landscape" />
            </div>

            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="images/Portfolio 4.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Mountains in the Clouds" />

                <img src="images/Portfolio 5.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Boat on Calm Water" />
            </div>

            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="images/Portfolio 6.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Waves at Sea" />

                <img src="images/Portfolio 7jpg.webp" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Yosemite National Park" />

                <img src="images/Portfolio 8.png" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Yosemite National Park" />
            </div>
        </div>
    </div>

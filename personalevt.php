    ...
    <div class="container">
        <div class="row my-5 py-3">
            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                <img src="images/portfolio 9.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Boat on Calm Water" />

                <img src="images/Portfolio 10.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Wintry Mountain Landscape" />
            </div>

            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="images/Portfolio 11.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Mountains in the Clouds" />

                <img src="images/Portfolio 12.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Boat on Calm Water" />
            </div>

            <div class="col-lg-4 mb-4 mb-lg-0">
                <img src="images/Portfolio 13.jpg" class="w-100 shadow-1-strong rounded mb-4" alt="Waves at Sea" />

                <img src="images/Portfolio 14.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Yosemite National Park" />

                <img src="images/Portfolio 15.jpg" class="w-100 shadow-1-strong rounded mb-4"
                    alt="Yosemite National Park" />
            </div>
        </div>
    </div>
